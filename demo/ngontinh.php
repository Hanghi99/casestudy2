...
$sql= "SELECT * From products where id_category=10";
                    ...
                    <ul>
                        <li class="active" data-filter="*"><a href="#" class="nav-link dropdown-toggle arrow"
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="kinhdi.php?id=1">Kinh dị</a></li>
                        ...
                        <div class="col-lg-4 col-md-4 all des">
                            <div class="product-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <button type="submit" class="btn btn-success"><a style='color:white'  href="productdetail.php">Mua</a></button>
                                </div>
                            </div>
